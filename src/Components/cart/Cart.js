...
const Cart = () => {
    ...
    const getinddata = async () => {
        ...
        const data = await fetch("http://localhost:5007/getproductsone/products4",{
            method:"GET",
            headers:{
                "Content-Type":"application/json"
            }
        ...
        // const res = await axios.get('http://localhost:5007/getproductsone/products');
